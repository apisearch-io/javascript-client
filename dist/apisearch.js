...
var _Query = __webpack_require__(46);

var _Query2 = _interopRequireDefault(_Query);

var _Repository = __webpack_require__(52);
...
var repository = new _Repository2.default(apisearch.endpoint, apisearch.secret);

repository.query(query).then(function (res) {
...
var Query = function () {
    ...
    (0, _createClass3.default)(Query, [{
        ...
        value: function create(queryText) {
            ...
            var size = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_SIZE;
