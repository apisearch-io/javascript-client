...
var _extends5 = __webpack_require__(59);
...
var Query = function () {
    ...
    (0, _createClass3.default)(Query, [{
        ...
        value: function filterBy(filterName, field, values) {
            ...
            if (values.length !== 0) {
                this.filters = (0, _extends6.default)({}, this.filters, (0, _defineProperty3.default)({}, filterName, new _Filter2.default(fieldPath, values, applicationType, _Filter.FILTER_TYPE_FIELD)));
            } else {
        ...
        value: function filterUniverseBy(field, values) {
            ...
            var fieldPath = _Filter2.default.getFilterPathByField(field);
            if (values.length !== 0) {
                this.universe_filters = (0, _extends6.default)({}, this.universe_filters, (0, _defineProperty3.default)({}, field, new _Filter2.default(fieldPath, values, applicationType, _Filter.FILTER_TYPE_FIELD)));
            } else {
        ...
        value: function aggregateBy(filterName, field, applicationType) {
            ...
            this.aggregations = (0, _extends6.default)({}, this.aggregations, (0, _defineProperty3.default)({}, filterName, new _Aggregation2.default(filterName, _Filter2.default.getFilterPathByField(field), applicationType, _Filter.FILTER_TYPE_FIELD, [], aggregationSort, limit)));
...
exports.FILTER_TYPE_QUERY = exports.FILTER_TYPE_GEO = exports.FILTER_TYPE_DATE_RANGE = exports.FILTER_TYPE_RANGE = exports.FILTER_TYPE_FIELD = exports.FILTER_PROMOTE = exports.FILTER_EXCLUDE = exports.FILTER_AT_LEAST_ONE = exports.FILTER_MUST_ALL_WITH_LEVELS = exports.FILTER_MUST_ALL = undefined;
...
exports.AGGREGATION_NO_LIMIT = exports.AGGREGATION_SORT_BY_NAME_DESC = exports.AGGREGATION_SORT_BY_NAME_ASC = exports.AGGREGATION_SORT_BY_COUNT_DESC = exports.AGGREGATION_SORT_BY_COUNT_ASC = undefined;
...
var HttpRepository = function () {
    ...
    function HttpRepository(endpoint, secret) {
        (0, _classCallCheck3.default)(this, HttpRepository);
    ...
    (0, _createClass3.default)(HttpRepository, [{
        key: "query",
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_query) {
                var composedQuery;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                composedQuery = this.endpoint + "?key=" + this.secret + "&query=" + _query;
                                _context.next = 4;
