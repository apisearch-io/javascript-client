...
var apisearch = {
    ...
    client: function client(repository, endpoint, secret) {
        this.repository = repository;
        this.endpoint = endpoint;
        this.secret = secret;
    },
    query: function query(queryText, page, size) {
    ...
    search: function search(query, callback) {
        ...
        return repository.query(query).then(function (res) {
            return callback(res);
        });
    }
};
...
var Query = function (_BaseQuery) {
    (0, _inherits3.default)(Query, _BaseQuery);

    function Query(props) {
        (0, _classCallCheck3.default)(this, Query);
        return (0, _possibleConstructorReturn3.default)(this, (Query.__proto__ || Object.getPrototypeOf(Query)).call(this, props));
    }
    ...
    (0, _createClass3.default)(Query, [{
        ...
        value: function filterUniverseBy(field, values) {
            var applicationType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _Filter.AT_LEAST_ONE;
        }
    }, {
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(11)(Function.call, __webpack_require__(117).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
exports.TYPE_QUERY = exports.TYPE_GEO = exports.TYPE_DATE_RANGE = exports.TYPE_RANGE = exports.TYPE_FIELD = exports.PROMOTE = exports.EXCLUDE = exports.AT_LEAST_ONE = exports.MUST_ALL_WITH_LEVELS = exports.MUST_ALL = undefined;
 ...
 * filter constants
 */
var MUST_ALL = exports.MUST_ALL = 4;
var MUST_ALL_WITH_LEVELS = exports.MUST_ALL_WITH_LEVELS = 5;
var AT_LEAST_ONE = exports.AT_LEAST_ONE = 8;
var EXCLUDE = exports.EXCLUDE = 16;
var PROMOTE = exports.PROMOTE = 32;
var TYPE_FIELD = exports.TYPE_FIELD = 'field';
var TYPE_RANGE = exports.TYPE_RANGE = 'range';
var TYPE_DATE_RANGE = exports.TYPE_DATE_RANGE = 'date_range';
var TYPE_GEO = exports.TYPE_GEO = 'geo';
...
var Filter = function () {
    function Filter(field, values, application_type, filter_type, filter_terms) {
        (0, _classCallCheck3.default)(this, Filter);

        this.field = field;
        this.values = filter_type !== TYPE_GEO ? Object.keys(values) : values;
    ...
    (0, _createClass3.default)(Filter, [{
        key: 'create',
        value: function create(field, values, applation_type, filter_type) {
            var filter_terms = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : [];
